...
position = recupérerPosition(joueur)
...
Fonction RecupérerPosition(Joueur) // Retourne l'id de la case sur lequel se trouve le joueur
Fonction afficherCasesPossible(position, resultat) // Retourne un tableau de case possibles à distance de la position actuelle
Fonction deplacerJoueur(position) // déplacer le joueur a une position donnée, renvoie la nouvelle position
Fonction recupérerThème(case) // rénvoie le thème de case passé en paramètre
